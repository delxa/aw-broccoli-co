...
describe('EnquiryModal', () => {
  test('renders modal if showModal=true', () => {
    const wrapper = mount(<EnquiryModal showModal success={false} failure={false} creating={false} createEnquiry={noop} hideEnquiryModal={noop} />)
  ...
  test('renders thank you when successful', () => {
    const wrapper = mount(<EnquiryModal showModal success failure={false} creating={false} createEnquiry={noop} hideEnquiryModal={noop} />)
  ...
  test('clicking cancel button calls onClose Prop', () => {
    ...
    const wrapper = mount(<EnquiryModal showModal success={false} failure={false} creating={false} createEnquiry={noop} hideEnquiryModal={mockOnClose} />)
  ...
  test('clicking Close this dialogue calls onClose Prop', () => {
    const mockOnClose = jest.fn()
    const wrapper = mount(<EnquiryModal showModal success failure={false} creating={false} createEnquiry={noop} hideEnquiryModal={mockOnClose} />)
