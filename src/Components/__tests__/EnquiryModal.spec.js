...
describe('EnquiryModal', () => {
  ...
  test('renders modal if showModal=true', () => {
    const wrapper = mount(<EnquiryModal showModal={true} success={false} />)
    expect(wrapper.find('.modal')).toExist()
  }) 

  test('does not render modal if showModal=false', () => {
    const wrapper = mount(<EnquiryModal showModal={false} success={false} />)
  ...
  test('renders thank you when successful', () => {
    const wrapper = mount(<EnquiryModal showModal={true} success={true} />)
  ...
  test('clicking cancel button calls onClose Prop', () => {
    ...
    const wrapper = mount(<EnquiryModal showModal={true} success={false} hideEnquiryModal={mockOnClose} />)
  ...
  test('clicking Close this dialogue calls onClose Prop', () => {
    const mockOnClose = jest.fn()
    const wrapper = mount(<EnquiryModal showModal={true} success={true} hideEnquiryModal={mockOnClose} />)
